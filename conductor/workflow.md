...
3. **Compilation is Key:** Ensure the project compiles successfully after every significant change using `./gradlew classes`.
...
4. **Verify Syntax & Compilation:**
   - **CRITICAL:** Run the compilation check to ensure your changes haven't broken the build.
...
5. **Refactor (Optional but Recommended):**
   ...
   - Rerun `./gradlew classes` to ensure the build remains stable.
...
2.  **Verify Compilation for Phase Changes:**
    -   **Action:** Run the full compilation command to ensure the entire phase's work is syntactically correct.
    -   **Command:** `./gradlew classes`
    -   If the build fails, you **must** inform the user and begin debugging.
...
3.  **Propose a Detailed, Actionable Manual Verification Plan:**
    ...
    -   The plan you present to the user **must** follow this format:
        ...
        **For a Frontend Change:**
        ```
        The build has passed. For manual verification, please follow these steps:
...
6.  **Attach Auditable Verification Report using Git Notes:**
    -   **Step 6.1: Draft Note Content:** Create a detailed verification report including the build command used, the manual verification steps, and the user's confirmation.
...
- [ ] Builds successfully (`./gradlew classes`)
